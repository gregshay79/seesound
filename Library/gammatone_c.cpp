 ...
 *=======================
 */
void gtFilter(double *x, int nsamples, int fs, double cf, int hrect)
//void mexFunction ( int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[] )
{
   double *bm, *env, *instp, *instf; // *x
//   int i, j, t;//, fs, nsamples, hrect;
   int t;
   double a, tpt, tptbw, gain; // cf
